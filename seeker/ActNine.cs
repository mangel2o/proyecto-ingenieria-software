...
public class ActNine{
   public void executeProgram(string path){
      //INICIA EL CRONOMETRO
      Stopwatch watch = Stopwatch.StartNew();
      Console.WriteLine("Actividad 9 en proceso... ");
      ...
      Directory.CreateDirectory(path + "\\results\\act9");
      ...
      File.WriteAllText(path + "\\results\\act9\\consolidatedFilePostings.html", dataTablePostings.ToMinimalString());
      File.WriteAllText(path + "\\results\\act9\\consolidatedFile.html", dataTable.ToMinimalString());
      File.WriteAllText(path + "\\results\\act9\\results.txt", "\nTiempo total en ejecutar el programa: " + watch.Elapsed);
      Console.WriteLine("Actividad 9 completada exitosamente, Noice\n");
   }
}
