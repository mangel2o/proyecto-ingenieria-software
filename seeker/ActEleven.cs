...
public class ActEleven{
   public void executeProgram(string path){
      //INICIA EL CRONOMETRO
      Stopwatch watch = Stopwatch.StartNew();
      Console.WriteLine("Actividad 11 en proceso... ");
      ...
      Directory.CreateDirectory(path + "\\results\\act11");
      ...
      File.WriteAllText(path + "\\results\\act11\\posting.html", dataTablePostings.ToMinimalString());
      File.WriteAllText(path + "\\results\\act11\\file.html", dataTable.ToMinimalString());
      File.WriteAllText(path + "\\results\\act11\\relation.html", dataTableRelations.ToMinimalString());
      File.WriteAllText(path + "\\results\\act11\\results.txt", "\nTiempo total en ejecutar el programa: " + watch.Elapsed);
      Console.WriteLine("Actividad 11 completada exitosamente, Noice\n");
   }
}
