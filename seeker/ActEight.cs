...
public class ActEight{
   public void executeProgram(string path){
      //INICIA EL CRONOMETRO
      Stopwatch watch = Stopwatch.StartNew();
      Console.WriteLine("Actividad 8 en proceso... ");
      ...
      Directory.CreateDirectory(path + "\\results\\act8");
      ...
      File.WriteAllText(path + "\\results\\act8\\consolidatedFilePostings.html", dataTablePostings.ToMinimalString());
      File.WriteAllText(path + "\\results\\act8\\consolidatedFile.html", dataTable.ToMinimalString());
      File.WriteAllText(path + "\\results\\act8\\results.txt", "\nTiempo total en ejecutar el programa: " + watch.Elapsed);
      Console.WriteLine("Actividad 8 completada exitosamente, Noice\n");
   }
}
